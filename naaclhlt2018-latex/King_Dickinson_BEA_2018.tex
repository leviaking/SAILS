...
whether it is being analyzed for grammatical errors \citep{leacock:ea:14}, for
linguistic patterns \citep{kyle2015automatically}, for content analysis \citep{weigle2013english}, or for interactions with intelligent computer-assisted language learning
(ICALL) systems \citep{amaral:meurers:user:07}.  One of the core issues in doing anything with
...
would be wise to constrain the data in some way \citep{somasundaran:chodorow:14, somasundaran:ea:15}, \lk{Is this kind of what you had in mind?} but we do not
