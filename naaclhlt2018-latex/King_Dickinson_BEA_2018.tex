...
\hline
\end{tabular}
\caption{\label{tab:NSvNNSagreement} Comparing agreement for NS and NNS test set responses: average \textit{yes} annotations (\textit{AvgYes}) and Cohen's kappa (\textit{Kappa}).}
\end{center}
\end{table}
