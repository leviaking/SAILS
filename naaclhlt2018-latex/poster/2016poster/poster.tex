...
\vspace{-1em}
\begin{block}{Generalizing the Methods}
...
\begin{center}
% MD: To adjust the overall width of the box, adjust the width of minipage:
...
\\\mbox{}\hfill Goal: new PDT items could be placed into known clusters via response features \& optimal parameter settings for that cluster could be applied automatically\\ %. This work is ongoing\\%, but initial results suggest that such correlations do exist. \\

\bigskip
\bigskip

%%LK: In this version of the clusters, the heights of clusters are taller (meaning less vertical space in the column(s) above.
...
%\node (1037) at (-2.3,2) {};
%\node (281037) at (-4.5,3) {};
%\node (6281037) at (-7.5,4) {};
%\node (146281037) at (-10,5) {};
%\node (59146281037) at (-13.5,6) {};
%\draw  (5)  |- (59.center);
%\draw  (9)  |- (59.center);
%\draw  (1)  |- (14.center);
%\draw  (4)  |- (14.center);
...
%%LK: In this version of the clusters, the heights of clusters are shorter (meaning more vertical space in the column(s) above. 
\begin{minipage}{.45\textwidth}
\begin{figure}
\begin{center}
\begin{tikzpicture}[sloped]
