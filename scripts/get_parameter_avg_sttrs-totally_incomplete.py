...
## 2021/05/06. Adapted from get_parameter_avg_response_scores.py
## For all relevant samples (F14, NS14, NS50, NNS70), this script provides a standardized type-to-token ratio, in total and broken down by parameter setting.
