...
## Changed statsdir for the weighted_deps versions:
...
def main():
	...
	for brd in b_rank_docs:
		...
		## We need to add "-W" here so the bert source label matches the "all_spearman...csv" label
		blab = blab.replace("-"+test_sample, "-"+test_sample+"-W")
		blabels.append(blab)
