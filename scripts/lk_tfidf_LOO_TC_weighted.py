...
outputdir=('/Users/leviking/Documents/dissertation/SAILS/gold_standards/LOO_TC-weighted/')
...
def main():
	...
	while ci < len(allinput):
		...
		for deptype in ['ldh', 'xdh', 'xdx']:
			...
			gs_tfidf_pairs = get_weighted_term_tfidf_list(dtw, mygstokens, deptype)
			test_tfidf_pairs = get_weighted_term_tfidf_list(dtw, [mytesttokens], deptype) ##hacky solution -- list containing only one sublist
