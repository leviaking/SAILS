...
##items+TU+feature
for fn in allfns:
	fnagreesfile=open('agreement_files/combined/'+fn+'_token_agrees.csv', 'w')
	fndisagreesfile=open('agreement_files/combined/'+fn+'_token_disagrees.csv', 'w')
...
for n in range(28,31):
	...
	for tu in tuversions:
		itemtuagreesfile=open('agreement_files/combined/'+'I'+numstr+tu+'_token_agrees.csv', 'w')
		itemtuagreeswriter=csv.writer(itemtuagreesfile, dialect=csv.excel)
		itemtuagreeswriter.writerow(header)
		itemtudisagreesfile=open('agreement_files/combined/'+'I'+numstr+tu+'_token_disagrees.csv', 'w')
...
for n in range(28,31):
	numstr=str(n).zfill(2)
	for feat in feats:
		itemfeatagreesfile=open('agreement_files/combined/'+'I'+numstr+feat+'_token_agrees.csv', 'w')
		itemfeatagreeswriter=csv.writer(itemfeatagreesfile, dialect=csv.excel)
		itemfeatagreeswriter.writerow(header)
		itemfeatdisagreesfile=open('agreement_files/combined/'+'I'+numstr+feat+'_token_disagrees.csv', 'w')
...
for tu in tuversions:
	for feat in feats:
		feattuagreesfile=open('agreement_files/combined/'+tu+'_'+feat+'_token_agrees.csv', 'w')
		feattuagreeswriter=csv.writer(feattuagreesfile, dialect=csv.excel)
		feattuagreeswriter.writerow(header)
		feattudisagreesfile=open('agreement_files/combined/'+tu+'_'+feat+'_token_disagrees.csv', 'w')
...
for n in range(28,31):
	numstr=str(n).zfill(2)
	itemfeatagreesfile=open('agreement_files/combined/'+'I'+numstr+'_token_agrees.csv', 'w')
	itemfeatagreeswriter=csv.writer(itemfeatagreesfile, dialect=csv.excel)
	itemfeatagreeswriter.writerow(header)
	itemfeatdisagreesfile=open('agreement_files/combined/'+'I'+numstr+'_token_disagrees.csv', 'w')
	itemfeatdisagreeswriter=csv.writer(itemfeatdisagreesfile, dialect=csv.excel)
	itemfeatdisagreeswriter.writerow(header)
	for fn in allfns:
		if numstr in fn:
...
for tu in tuversions:
	tuagreesfile=open('agreement_files/combined/'+tu+'_token_agrees.csv', 'w')
	tuagreeswriter=csv.writer(tuagreesfile, dialect=csv.excel)
	tuagreeswriter.writerow(header)
	tudisagreesfile=open('agreement_files/combined/'+tu+'_token_disagrees.csv', 'w')
...
##features
for feat in feats:
	featagreesfile=open('agreement_files/combined/'+feat+'_token_agrees.csv', 'w')
	featagreeswriter=csv.writer(featagreesfile, dialect=csv.excel)
	featagreeswriter.writerow(header)
	featdisagreesfile=open('agreement_files/combined/'+feat+'_token_disagrees.csv', 'w')
