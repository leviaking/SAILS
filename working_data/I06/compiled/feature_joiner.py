...
def get_csv_names(itemnum, hour):
	tiname = 'I'+str(itemnum).zfill(2)+'T_Interp-'+hour+'.csv'
	tcname = 'I'+str(itemnum).zfill(2)+'T_Core-'+hour+'.csv'
	tvname = 'I'+str(itemnum).zfill(2)+'T_Verif-'+hour+'.csv'
	taname = 'I'+str(itemnum).zfill(2)+'T_Answer-'+hour+'.csv'
	uiname = 'I'+str(itemnum).zfill(2)+'U_Interp-'+hour+'.csv'
	ucname = 'I'+str(itemnum).zfill(2)+'U_Core-'+hour+'.csv'
	uvname = 'I'+str(itemnum).zfill(2)+'U_Verif-'+hour+'.csv'
	uaname = 'I'+str(itemnum).zfill(2)+'U_Answer-'+hour+'.csv'
	cnname = 'I'+str(itemnum).zfill(2)+'TU_Nativ-'+hour+'.csv'
	cgname = 'I'+str(itemnum).zfill(2)+'TU_Nativ-'+hour+'.csv'
	return tiname, tcname, tvname, taname, uiname, ucname, uvname, uaname, cnname, cgname
