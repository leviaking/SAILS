...
%Given this fact, the trend here suggests that the NNS participants and crowd- sourced NS participants exhibit more convergent behavior in response to transitive items (as opposed to intransitives and ditransitives), and thus a relatively granular representation (labeled dependencies) works well in similarity measures, leading to better discriminatory power for the INTERPRETABILITY feature.
