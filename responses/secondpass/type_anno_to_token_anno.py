...
for n in range(1,31):
	...
	if n in A2annoitems:	
		...
		A2coreTfile=open(A2coreTfilename, 'r')
		A2coreUfile=open(A2coreUfilename, 'r')
		...
		A2answerTfile=open(A2answerTfilename, 'r')
		A2answerUfile=open(A2answerUfilename, 'r')
		...
		# print A2grammTfilename
		A2grammTfile=open(A2grammTfilename, 'r')
		A2grammUfile=open(A2grammUfilename, 'r')
		...
		A2interpTfile=open(A2interpTfilename, 'r')
		A2interpUfile=open(A2interpUfilename, 'r')
		...
		A2verifTfile=open(A2verifTfilename, 'r')
		A2verifUfile=open(A2verifUfilename, 'r')
