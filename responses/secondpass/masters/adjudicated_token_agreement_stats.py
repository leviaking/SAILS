...
##items+TU+feature
for fn in allfns:
	fnagreesfile=open('agreement_files/'+fn+'_adjudicated_token_agrees.csv', 'w')
	fndisagreesfile=open('agreement_files/'+fn+'_adjudicated_token_disagrees.csv', 'w')
...
for n in range(1,4):
	...
	for tu in tuversions:
		itemtuagreesfile=open('agreement_files/'+'I'+numstr+tu+'_adjudicated_token_agrees.csv', 'w')
		itemtuagreeswriter=csv.writer(itemtuagreesfile, dialect=csv.excel)
		itemtuagreeswriter.writerow(header)
		itemtudisagreesfile=open('agreement_files/'+'I'+numstr+tu+'_adjudicated_token_disagrees.csv', 'w')
...
for n in range(1,4):
	numstr=str(n).zfill(2)
	for feat in feats:
		itemfeatagreesfile=open('agreement_files/'+'I'+numstr+feat+'_adjudicated_token_agrees.csv', 'w')
		itemfeatagreeswriter=csv.writer(itemfeatagreesfile, dialect=csv.excel)
		itemfeatagreeswriter.writerow(header)
		itemfeatdisagreesfile=open('agreement_files/'+'I'+numstr+feat+'_adjudicated_token_disagrees.csv', 'w')
...
for tu in tuversions:
	for feat in feats:
		feattuagreesfile=open('agreement_files/'+tu+'_'+feat+'_adjudicated_token_agrees.csv', 'w')
		feattuagreeswriter=csv.writer(feattuagreesfile, dialect=csv.excel)
		feattuagreeswriter.writerow(header)
		feattudisagreesfile=open('agreement_files/'+tu+'_'+feat+'_adjudicated_token_disagrees.csv', 'w')
...
for n in range(1,4):
	numstr=str(n).zfill(2)
	itemfeatagreesfile=open('agreement_files/'+'I'+numstr+'_adjudicated_token_agrees.csv', 'w')
	itemfeatagreeswriter=csv.writer(itemfeatagreesfile, dialect=csv.excel)
	itemfeatagreeswriter.writerow(header)
	itemfeatdisagreesfile=open('agreement_files/'+'I'+numstr+'_adjudicated_token_disagrees.csv', 'w')
	itemfeatdisagreeswriter=csv.writer(itemfeatdisagreesfile, dialect=csv.excel)
	itemfeatdisagreeswriter.writerow(header)
	for fn in allfns:
		if numstr in fn:
...
for tu in tuversions:
	tuagreesfile=open('agreement_files/'+tu+'_adjudicated_token_agrees.csv', 'w')
	tuagreeswriter=csv.writer(tuagreesfile, dialect=csv.excel)
	tuagreeswriter.writerow(header)
	tudisagreesfile=open('agreement_files/'+tu+'_adjudicated_token_disagrees.csv', 'w')
...
##features
for feat in feats:
	featagreesfile=open('agreement_files/'+feat+'_adjudicated_token_agrees.csv', 'w')
	featagreeswriter=csv.writer(featagreesfile, dialect=csv.excel)
	featagreeswriter.writerow(header)
	featdisagreesfile=open('agreement_files/'+feat+'_adjudicated_token_disagrees.csv', 'w')
...
statsname='adjudicated_token_agreement_stats_output.csv'
