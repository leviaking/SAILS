...
for n in range(1,4):
	...
	for tu in tuversions:
		...
		itemtudisagreesfile=open('agreement_files/'+'I'+numstr+tu+'_token_disagrees.csv', 'w')
...
for n in range(1,4):
	...
	for feat in feats:
		...
		itemfeatdisagreesfile=open('agreement_files/'+'I'+numstr+feat+'_token_disagrees.csv', 'w')
...
for n in range(1,4):
	...
	itemfeatagreeswriter=csv.writer(itemfeatagreesfile, dialect=csv.excel)
	itemfeatagreeswriter.writerow(header)
	itemfeatdisagreesfile=open('agreement_files/'+'I'+numstr+'_token_disagrees.csv', 'w')
	itemfeatdisagreeswriter=csv.writer(itemfeatdisagreesfile, dialect=csv.excel)
	itemfeatdisagreeswriter.writerow(header)
	for fn in allfns:
		if numstr in fn:
