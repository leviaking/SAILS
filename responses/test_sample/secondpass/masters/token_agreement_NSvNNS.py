...
##items+TU+feature
for fn in allfns:
	fnagreesfile=open('agreement_files/NSvNNS/'+fn+'_token_agrees.csv', 'w')
	fndisagreesfile=open('agreement_files/NSvNNS/'+fn+'_token_disagrees.csv', 'w')
...
for n in range(28,31):
	...
	for tu in tuversions:
		for speaker in speakers:
			itemtuagreesfile=open('agreement_files/NSvNNS/'+speaker+'_I'+numstr+tu+'_token_agrees.csv', 'w')
			itemtuagreeswriter=csv.writer(itemtuagreesfile, dialect=csv.excel)
			itemtuagreeswriter.writerow(header)
			itemtudisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_I'+numstr+tu+'_token_disagrees.csv', 'w')
...
for n in range(28,31):
	...
	for feat in feats:
		for speaker in speakers:
			itemfeatagreesfile=open('agreement_files/NSvNNS/'+speaker+'_I'+numstr+feat+'_token_agrees.csv', 'w')
			itemfeatagreeswriter=csv.writer(itemfeatagreesfile, dialect=csv.excel)
			itemfeatagreeswriter.writerow(header)
			itemfeatdisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_I'+numstr+feat+'_token_disagrees.csv', 'w')
...
for tu in tuversions:
	for feat in feats:
		for speaker in speakers:
			feattuagreesfile=open('agreement_files/NSvNNS/'+speaker+'_'+tu+'_'+feat+'_token_agrees.csv', 'w')
			feattuagreeswriter=csv.writer(feattuagreesfile, dialect=csv.excel)
			feattuagreeswriter.writerow(header)
			feattudisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_'+tu+'_'+feat+'_token_disagrees.csv', 'w')
...
for n in range(28,31):
	numstr=str(n).zfill(2)
	for speaker in speakers:
		itemfeatagreesfile=open('agreement_files/NSvNNS/'+speaker+'_I'+numstr+'_token_agrees.csv', 'w')
		itemfeatagreeswriter=csv.writer(itemfeatagreesfile, dialect=csv.excel)
		itemfeatagreeswriter.writerow(header)
		itemfeatdisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_I'+numstr+'_token_disagrees.csv', 'w')
		itemfeatdisagreeswriter=csv.writer(itemfeatdisagreesfile, dialect=csv.excel)
		itemfeatdisagreeswriter.writerow(header)
		for fn in allfns:
			if numstr in fn and speaker in fn:
...
for tu in tuversions:
	for speaker in speakers:
		tuagreesfile=open('agreement_files/NSvNNS/'+speaker+'_'+tu+'_token_agrees.csv', 'w')
		tuagreeswriter=csv.writer(tuagreesfile, dialect=csv.excel)
		tuagreeswriter.writerow(header)
		tudisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_'+tu+'_token_disagrees.csv', 'w')
...
for feat in feats:
	for speaker in speakers:
		featagreesfile=open('agreement_files/NSvNNS/'+speaker+'_'+feat+'_token_agrees.csv', 'w')
		featagreeswriter=csv.writer(featagreesfile, dialect=csv.excel)
		featagreeswriter.writerow(header)
		featdisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_'+feat+'_token_disagrees.csv', 'w')
...
##NSvNNS
for speaker in speakers:
	speakeragreesfile=open('agreement_files/NSvNNS/'+speaker+'_token_agrees.csv', 'w')
	speakeragreeswriter=csv.writer(speakeragreesfile, dialect=csv.excel)
	speakeragreeswriter.writerow(header)
	speakerdisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_token_disagrees.csv', 'w')
...
statsname='NSvNNS_token_agreement_stats_output.csv'
