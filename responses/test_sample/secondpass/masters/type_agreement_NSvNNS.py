				...
				for myfrow in myfrows:
					...
					if resp=='0':
						...
						if currentspeaker in speakers[speaker]:						
							...
							if resp not in resptypes:
								resptypes.append(resp)
								try:
...
for num in range(28,31):
	...
	for tu in tuversions:
		for speaker in speakers:	
			...
			mydisagrees=0
			for fn in allfns:
				if numstr in fn and tu in fn and speaker in fn:
			...
			try:
				...
				chanceagree='NA'
				#print 'kappa fail'
			ftrow=[speaker+'_I'+numstr+tu, myagrees, pagree, mydisagrees, pdisagree, mytotal, kappa, A1yes, A1yesp, A1no, A1nop, A2yes, A2yesp, A2no, A2nop, yeschanceagree, nochanceagree, chanceagree]
...
for num in range(28,31):
	...
	for feat in feats:
		for speaker in speakers:
			...
			mydisagrees=0
			for fn in allfns:
				if numstr in fn and feat in fn and speaker in fn:
					info=allstatsdict[fn]
					A1yes+=info[7]
					A1no+=info[9]
					A2yes+=info[11]
			...
			try:
				...
				chanceagree='NA'
				#print 'kappa fail'
			ftrow=[speaker+'_I'+numstr+feat, myagrees, pagree, mydisagrees, pdisagree, mytotal, kappa, A1yes, A1yesp, A1no, A1nop, A2yes, A2yesp, A2no, A2nop, yeschanceagree, nochanceagree, chanceagree]
			outrows.append(ftrow)
...
for feat in feats:
	for tu in tuversions:
		for speaker in speakers:
			...
			mydisagrees=0
			for fn in allfns:
				if feat in fn and tu in fn and speaker in fn:
					info=allstatsdict[fn]
					A1yes+=info[7]
					A1no+=info[9]
					A2yes+=info[11]
			...
			try:
				...
				chanceagree='NA'
				#print 'kappa fail'
			ftrow=[speaker+'_'+feat+'_'+tu, myagrees, pagree, mydisagrees, pdisagree, mytotal, kappa, A1yes, A1yesp, A1no, A1nop, A2yes, A2yesp, A2no, A2nop, yeschanceagree, nochanceagree, chanceagree]
			outrows.append(ftrow)
...
for num in range(28,31):
	...
	for speaker in speakers:
		...
		mydisagrees=0
		for fn in allfns:
			if numstr in fn and speaker in fn:
				info=allstatsdict[fn]
				A1yes+=info[7]
				A1no+=info[9]
				A2yes+=info[11]
		...
		try:
			...
			chanceagree='NA'
			#print 'kappa fail'
		ftrow=[speaker+'_I'+numstr, myagrees, pagree, mydisagrees, pdisagree, mytotal, kappa, A1yes, A1yesp, A1no, A1nop, A2yes, A2yesp, A2no, A2nop, yeschanceagree, nochanceagree, chanceagree]
		outrows.append(ftrow)	
...
for feat in feats:
	for speaker in speakers:
		...
		mydisagrees=0
		for fn in allfns:
			if feat in fn and speaker in fn:
				info=allstatsdict[fn]
				A1yes+=info[7]
				A1no+=info[9]
				A2yes+=info[11]
		...
		try:
			...
			chanceagree='NA'
			#print 'kappa fail'
		ftrow=[speaker+'_'+feat, myagrees, pagree, mydisagrees, pdisagree, mytotal, kappa, A1yes, A1yesp, A1no, A1nop, A2yes, A2yesp, A2no, A2nop, yeschanceagree, nochanceagree, chanceagree]
		outrows.append(ftrow)
...
for tu in tuversions:
	for speaker in speakers:
		...
		try:
			...
			chanceagree='NA'
			#print 'kappa fail'
		ftrow=[speaker+'_'+tu, myagrees, pagree, mydisagrees, pdisagree, mytotal, kappa, A1yes, A1yesp, A1no, A1nop, A2yes, A2yesp, A2no, A2nop, yeschanceagree, nochanceagree, chanceagree]
		outrows.append(ftrow)
...
for speaker in speakers:
	...
	try:
		...
		chanceagree='NA'
		#print 'kappa fail'
	ftrow=[speaker, myagrees, pagree, mydisagrees, pdisagree, mytotal, kappa, A1yes, A1yesp, A1no, A1nop, A2yes, A2yesp, A2no, A2nop, yeschanceagree, nochanceagree, chanceagree]
	outrows.append(ftrow)
...
##items+TU+feature
for fn in allfns:
	fnagreesfile=open('agreement_files/NSvNNS/'+fn+'_type_agrees.csv', 'w')
	fndisagreesfile=open('agreement_files/NSvNNS/'+fn+'_type_disagrees.csv', 'w')
...
for n in range(28,31):
	...
	for tu in tuversions:
		for speaker in speakers:
			itemtuagreesfile=open('agreement_files/NSvNNS/'+speaker+'_I'+numstr+tu+'_type_agrees.csv', 'w')
			itemtuagreeswriter=csv.writer(itemtuagreesfile, dialect=csv.excel)
			itemtuagreeswriter.writerow(header)
			itemtudisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_I'+numstr+tu+'_type_disagrees.csv', 'w')
...
for n in range(28,31):
	...
	for feat in feats:
		for speaker in speakers:
			itemfeatagreesfile=open('agreement_files/NSvNNS/'+speaker+'_I'+numstr+feat+'_type_agrees.csv', 'w')
			itemfeatagreeswriter=csv.writer(itemfeatagreesfile, dialect=csv.excel)
			itemfeatagreeswriter.writerow(header)
			itemfeatdisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_I'+numstr+feat+'_type_disagrees.csv', 'w')
			itemfeatdisagreeswriter=csv.writer(itemfeatdisagreesfile, dialect=csv.excel)
			itemfeatdisagreeswriter.writerow(header)
			for fn in allfns:
				if feat in fn and numstr in fn and speaker in fn:
...
for tu in tuversions:
	for feat in feats:
		for speaker in speakers:
			feattuagreesfile=open('agreement_files/NSvNNS/'+speaker+'_'+tu+'_'+feat+'_type_agrees.csv', 'w')
			feattuagreeswriter=csv.writer(feattuagreesfile, dialect=csv.excel)
			feattuagreeswriter.writerow(header)
			feattudisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_'+tu+'_'+feat+'_type_disagrees.csv', 'w')
...
for n in range(28,31):
	numstr=str(n).zfill(2)
	for speaker in speakers:
		itemfeatagreesfile=open('agreement_files/NSvNNS/'+speaker+'_I'+numstr+'_type_agrees.csv', 'w')
		itemfeatagreeswriter=csv.writer(itemfeatagreesfile, dialect=csv.excel)
		itemfeatagreeswriter.writerow(header)
		itemfeatdisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_I'+numstr+'_type_disagrees.csv', 'w')
		itemfeatdisagreeswriter=csv.writer(itemfeatdisagreesfile, dialect=csv.excel)
		itemfeatdisagreeswriter.writerow(header)
		for fn in allfns:
			if numstr in fn and speaker in fn and speaker in fn:
				itemfeatagrees=allagrees[fn]
				itemfeatdisagrees=alldisagrees[fn]
				for r in itemfeatagrees:
					itemfeatagreeswriter.writerow([fn]+r)
...
for tu in tuversions:
	for speaker in speakers:
		tuagreesfile=open('agreement_files/NSvNNS/'+speaker+'_'+tu+'_type_agrees.csv', 'w')
		tuagreeswriter=csv.writer(tuagreesfile, dialect=csv.excel)
		tuagreeswriter.writerow(header)
		tudisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_'+tu+'_type_disagrees.csv', 'w')
...
for feat in feats:
	for speaker in speakers:
		featagreesfile=open('agreement_files/NSvNNS/'+speaker+'_'+feat+'_type_agrees.csv', 'w')
		featagreeswriter=csv.writer(featagreesfile, dialect=csv.excel)
		featagreeswriter.writerow(header)
		featdisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_'+feat+'_type_disagrees.csv', 'w')
...
##NSvNNS
for speaker in speakers:
	speakeragreesfile=open('agreement_files/NSvNNS/'+speaker+'_type_agrees.csv', 'w')
	speakeragreeswriter=csv.writer(speakeragreesfile, dialect=csv.excel)
	speakeragreeswriter.writerow(header)
	speakerdisagreesfile=open('agreement_files/NSvNNS/'+speaker+'_type_disagrees.csv', 'w')
	speakerdisagreeswriter=csv.writer(speakerdisagreesfile, dialect=csv.excel)
	speakerdisagreeswriter.writerow(header)
	for fn in allfns:
		if speaker in fn:
			speakeragrees=allagrees[fn]
			speakerdisagrees=alldisagrees[fn]
			for r in speakeragrees:
				speakeragreeswriter.writerow([fn]+r)
			for d in speakerdisagrees:
				speakerdisagreeswriter.writerow([fn]+d)
	speakeragreesfile.close()
	speakerdisagreesfile.close()

	
statsname='NSvNNS_type_agreement_stats_output.csv'
#statsfile=open('agreement_files/NSvNNS/'+statsname, 'w')
