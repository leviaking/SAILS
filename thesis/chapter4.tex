...
Annotator 1 (A1) performed the A/B test for all 1,200 of the sampled response pairs. Annotator 2 (A2) performed the A/B test for a subset of 300 response pairs, for the purpose of measuring inter-annotator agreement. These are the same annotators from the feature annotation task, discussed in Section~\ref{sec:agreement}. For each A/B decision, a pair of responses along with the item image and question were presented to the annotator. The annotations for the responses were not included. 

NOTES below

(Buttons, choosing response...)

Instructions, rationale, how does knowledge of feature annotation influence this A/B task -- explain and justify.

Agreement

Deriving the weights -- explain the math, discuss the results.
