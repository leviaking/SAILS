...
The remaining 29 NS participants were people known to me personally; I refer to this group as the \param{familiar} native speakers (FNSs).
...
A total of 13,533 responses were collected. The response counts for each participant group are presented in Table~\ref{tab:response-counts}. Including the second responses collected from NSs, roughly two thirds of the corpus came from the NS groups. The overwhelming majority of responses appeared to be given in good faith, but a small number of responses (primarily from the CNS group) were problematic in this regard, as shown in Table~\ref{tab:bad-faith}. These may contain gibberish or obscenities or were otherwise inappropriate for the task. Such responses would also be expected in an ICALL environment, so they were not removed from the corpus. Instead, these responses were simply annotated like all others (see Chapter~\ref{chap:annotation}). Indeed, automatically assigning low scores to inappropriate responses is a central challenge and goal in this project.
