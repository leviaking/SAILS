...
\param{Brown} appears among top scoring configurations more often than does \param{WSJ}. Finally, for the term representation, labeled (\param{ldh}) and unlabeled (\param{xdh}) dependencies score are used most among the top scoring configurations.
