...
%%% YES, 100% confirmed 4/1/21! 
%[ Should include 4 configs: TARG/UNTARG, PRIM/MIX; DONE: Double check numbers \& highlighting ]
}
\end{center}
\end{table}
...
%%% YES, 100% confirmed 4/1/21! 
%[ Should include 6 configs: PRIM/MIX, LDH/XDH/XDX; DONE: Double check numbers \& highlighting ]
}
\end{center}
\end{table}
...
%%% YES, 100% confirmed 4/1/21! 
%[ Should include 6 configs: TARG/UNTARG, LDH/XDH/XDX; DONE: Double check numbers \& highlighting ]
}
\end{center}
\end{table}
...
%%% YES, 100% confirmed 4/1/21! 
%[ XYZ: Should include 6 configs: (MIX ONLY!), TARG/UNTARG, LDH/XDH/XDX; TODO: Double check numbers \& highlighting; pay special attention to use MIXED (r2) only ]
}
\end{center}
\end{table}
...
\hline
mean 	& 0.343 	& 0.339 & 0.498		& 0.342 		& 0.345 		& 0.509		 \\
\hline
median 	& 0.350 	& 0.318 & 0.521 	& 0.344 		& 0.332 		& 0.523		 \\
\hline
min 	& -0.314 	& -0.281 & -0.212 	& -0.269 		& -0.234 		& -0.090		 \\
\hline
max		& 0.901 	& 0.900 & 0.884 	& 0.894 		& 0.900 		& 0.881		 \\
\hline
...
%%% YES, 100% confirmed 4/1/21! 
%[ Should include 12 configs: TARG/UNTARG, PRIM/MIXED, LDH/XDH/XDX; DONE: Double check numbers \& highlighting; pay special attention... we haven't pulled stats from all 12 configs like this before... ]
}
...
%%% YES, 100% confirmed 4/1/21! 
%[ Should include 4 configs: TARG/UNTARG, PRIM/MIXED, (separately for LDH/XDH/XDX); DONE: Double check numbers \& highlighting; pay special attention... we haven't pulled stats from all 12 configs like this before... ]
}
\end{center}
\end{table}
