...
\textbf{XYZ: Numbers have changed. Ensure that trends discussed here are still accurate.}
...
intransitives avg length: xxxx

transitives avg length: xxxx

ditransitives avg length: xxxx
