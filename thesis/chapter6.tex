...
To help contextualize the results of these experiments, I used a state-of-the-art language modeling tool called BERT to rank responses according to their similarity to the NS model. I discuss this tool and its use as a benchmark in Section~\ref{sec:bert-baseline}.
...
\end{tabular}
\caption{\label{tab:response-length}Comparing average response length for the samples used throughout this chapter as NS models and NNS test sets, in total and by parameter setting.
}
\end{center}
\end{table}
...
\hline
   	& \param{Fam} & \param{Crowd} & \param{Crowd} 	& NNS			\\ \hline
\hline
Intrans & in 	  		& in 			& in 		& 0.391 		\\ \hline
Trans   & tr          	& tr          	& tr        & 0.517    	    \\ \hline
Ditrans & di          	& di          	& di        & 0.606    	    \\ \hline
\hline
Target  & targ 			& targ	 		& targ 		& 0.481			\\ \hline
Untarg  & untg        	& untg        	& untg    	& 0.528        	\\ \hline
\hline
Primary & N/A        	& prim 			& prim		& 0.505		 	\\ \hline
Mixed   & mix          	& mix          	& mix       & N/A	        \\ \hline
\hline
ldh     & ldh          	& ldh          	& ldh       & 0.578	        \\ \hline
xdh     & xdh          	& xdh          	& xdh       & 0.572	        \\ \hline
xdx     & xdx 			& xdx 			& xdx		& 0.364			\\ \hline
\hline
Total    & tot          & tot          & tot      	& 0.505	        \\ \hline
\end{tabular}
