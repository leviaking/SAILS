...
count & 120 & 120 & 120 \\
\hline
mean & 0.4126 & 0.3420 & 0.2733 \\
\hline
median & 0.4164 & 0.3314 & 0.2780 \\
\hline
min & -0.0766 & -0.0303 & -0.2690 \\
\hline
max & 0.8949 & 0.7784 & 0.7099 \\
\hline
std dev & 0.2435 & 0.2047 & 0.1957 \\
\hline
\end{tabular}
\caption{\label{tab:transitivity-results} Comparing Spearman rank correlation scores for \param{intransitive}, \param{transitive} and \param{ditransitive} PDT items. Each column represents 120 different rankings (12 system configurations $\times$ 10 items) of 70 NNS responses, where each ranking receives a Spearman score via comparison with the weighted annotation ranking.}
\end{center}
\end{table}
...
\begin{tabular}{|l||l|l|}
\hline
& \param{Targeted} & \param{Untargeted} \\
\hline
\hline
count & 180 & 180  \\
\hline
mean & 0.3850 & 0.3001  \\
\hline
median & 0.3828 & 0.3137  \\
\hline
min & -0.0482 & -0.2690  \\
\hline
max & 0.8723 & 0.8949 \\
\hline
std dev & 0.2329 & 0.2033 \\
\hline
\end{tabular}
\caption{\label{tab:targeting-results} Comparing Spearman rank correlation scores for \param{targeted} and \param{untargeted} versions of the PDT data. Each column represents 180 different rankings (6 system configurations $\times$ 30 items) of 70 NNS responses, where each ranking receives a Spearman score via comparison with the weighted annotation ranking.}
\end{center}
\end{table}
...
mean & 0.3376 & 0.3475  \\
\hline
median & 0.3272 & 0.3616  \\
\hline
min & -0.2690 & -0.1476  \\
\hline
max & 0.8903 & 0.8949 \\
\hline
std dev & 0.2182 & 0.2270 \\
\hline
\end{tabular}
...
\begin{tabular}{|l||l|l|l|}
\hline
& \param{ldh} & \param{xdh} & \param{xdx} \\
\hline
\hline
count & 120 & 120 & 120  \\
\hline
mean & 0.3502 & 0.3422 & 0.3353  \\
\hline
median & 0.3642 & 0.3687 & 0.3224  \\
\hline
min & -0.1476 & -0.2690 & -0.0751  \\
\hline
max & 0.8924 & 0.8915 & 0.8949 \\
\hline
std dev & 0.2293 & 0.2359 & 0.2022 \\
\hline
\end{tabular}
